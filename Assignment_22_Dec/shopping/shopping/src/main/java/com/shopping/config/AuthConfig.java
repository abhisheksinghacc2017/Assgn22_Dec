...
import com.shopping.filter.JwtRequestFilter;
 ...
 */
@OpenAPIDefinition(
	info = @Info(title = "Product Service", version = "v3"),
...
public class AuthConfig {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        .authorizeHttpRequests((authz) -> authz
            .requestMatchers( new AntPathRequestMatcher("/shop/**")).hasAnyRole("ADMIN", "CUSTOMER")
            .requestMatchers( new AntPathRequestMatcher("/admin/**")).hasRole("ADMIN")
            .requestMatchers( new AntPathRequestMatcher("/product/**")).hasRole("CUSTOMER")
